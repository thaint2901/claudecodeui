  ...
  OPTIONS: [
    {
      ...
      description: 'Recommended model for your account (Opus for Max/Team Premium/Enterprise pay-as-you-go, Sonnet for Pro/Team Standard)',
      effort: {
        default: 'high',
        values: [
          { value: 'low' },
    ...
    },
    {
      value: "sonnet",
      label: "Sonnet",
      description: "Sonnet 5 · Best for everyday tasks · native 1M context · $3/$15 per Mtok",
      effort: {
        default: 'high',
        values: [
          { value: 'low' },
    ...
    },
    {
      ...
      description: 'Opus 4.8 with 1M context · auto-included on Max/Team/Enterprise · $5/$25 per Mtok',
      effort: {
        default: 'high',
        values: [
          { value: 'low' },
    ...
    },
    {
      value: 'opusplan',
      label: 'Opus Plan',
      description: 'Opus for planning, automatically switches to Sonnet for execution',
      effort: {
        default: 'high',
        values: [
          { value: 'low' },
